...
function Products() {
  ...
  const products: Record<ProductKey, any> = {
    surveyvista: {
  ...
  const productNames: Record<ProductKey, any> = {
    surveyvista: {
      name: "SurveyVista",
      subtitle: "Intelligence & Action",
      icon: "/assets/ProductLogo/SurveyVistaLogo.webp",
    },
    formvista: {
      name: "FormVista",
      subtitle: "Native Forms",
      icon: "/assets/ProductLogo/FormVistaLogo.webp",
    },
    compliancevista: {
      name: "ComplianceVista",
      subtitle: "Risk & Compliance",
      icon: "/assets/ProductLogo/ComplainceVistaLogo.webp",
    },
    agentvista: {
      name: "AgentVista",
      subtitle: "AI-Powered Agents",
      icon: "/assets/ProductLogo/AgentVistaLogo.webp",
    },
    relationshipvista: {
      name: "RelationshipVista",
      subtitle: "Account Hierarchies",
      icon: "/assets/ProductLogo/RelationshipVistaLogo.webp",
    },
  };
  ...
  const handleTabClick = (key: ProductKey) => {
    setActiveTab(key);
      ...
      <div className="product-tabs">
        <div className="tabs-list">
          {productKeys.map((key) => (
            ...
            >
              <img src={productNames[key].icon} alt={productNames[key].name} />
              <div>
